			...
			<div class="agile-grids">	
				...
				<div class="grids">
                    ...
                    if(!$con){
                        ...
                        if(!empty($_POST['postoff'])){
                            
                            $room_num=$_POST['room_num'];
                            $off=$_POST['off'];
                            $des=$_POST['des'];
                            
                            $insert="insert into offer(room_num,off,des) values('$room_num','$off','$des')";
						...
						<div class="forms">
							<div class="form-three widget-shadow">
								<div class=" panel-body-inputin">
									<form class="form-horizontal" action="offer.php" enctype="multipart/form-data" method="post">
                    ...
                    if(!$con){
                        echo "<script>alert('connection not establish')</script>";
                                                    ...
                                                    while($of=mysqli_fetch_array($query))
                                                          {
                                                              $room_num=$of[0];
                                                        ?>      
                                                        
                                                    <option vlaue="<?php  echo $room_num; ?>"><?php  echo $room_num; ?></option>
                                        ...
                                        <div class="form-group">
											...
											<div class="col-md-8">
												<div class="input-group">
													...
													<input type="text" class="form-control1" id="exampleInputPassword1" name="off" placeholder="Offer">
												</div>
											</div>
										</div>
                                        ...
                                        <div class="form-group">
											...
											<div class="col-md-8">
												<div class="input-group">
													...
													<textarea class="form-control" name="des" cols="5" rows="5"></textarea>
												</div>
											</div>
										</div>
                                        
                                        <input type="submit" name="postoff" value="submit" class="btn btn-primary w3ls-button"/>
									</form>
								</div>
							</div>
						</div>
